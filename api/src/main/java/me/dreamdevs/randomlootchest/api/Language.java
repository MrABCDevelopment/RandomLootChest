...
public enum Language {
	...
	CHEST_NO_ITEMS("ChestMessages.No-Items-In-Chest", "&cThere is no items in this chest! Better luck next time!"),
	...
	RANDOM_CHEST_SPAWN("RandomChest.Spawn-Message","&4-------------------------------------\n&aThe chest &e%TYPE% &awas spawned on location: &e%COORDINATES%\n&4-------------------------------------"),
