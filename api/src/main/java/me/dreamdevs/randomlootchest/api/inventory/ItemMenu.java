...
public class ItemMenu {
	...
	public void open(Player player) {
		if (!ItemMenuListener.getInstance().isRegistered(RandomLootChestApi.INSTANCE)) {
			ItemMenuListener.getInstance().register(RandomLootChestApi.INSTANCE);
		}
