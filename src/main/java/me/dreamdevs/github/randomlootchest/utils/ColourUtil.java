...
public class ColourUtil {
    ...
    public static List<String> colouredLore(String... lore) {
        return lore != null ? Arrays.stream(lore).map(s -> ChatColor.translateAlternateColorCodes('&', s)).collect(Collectors.toList()) : new ArrayList<>();
    }

    public static List<String> colouredLore(List<String> lore) {
        return lore != null ? lore.stream().map(s -> ChatColor.translateAlternateColorCodes('&', s)).collect(Collectors.toList()) : new ArrayList<>();
    }
